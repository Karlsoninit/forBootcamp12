...
//             key.id === id ? console.log(key) : undefined;
//         }
...
//          for (let key of this.notes) {
//             key.title.toLowerCase().includes(query) || key.body.toLowerCase().includes(query) ? arr.push(key) : null
//         }
...
//         for(let key of this.notes) {
//             key.priority === priority? arr.push(key) : null
//         }
